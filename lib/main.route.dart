...
import 'app/bike/create/create_page.dart' as a2;
import 'app/bike/read/[id]_page.dart' as a3;
import 'app/bike/update/[id]_page.dart' as a4;
import 'app/contact/contact_page.dart' as a5;
import 'app/notfound_page.dart' as a6;
...
Route b2Builder(BuildContext ctx, RouteSettings settings) =>
    Routefly.defaultRouteBuilder(ctx, settings, const a2.CreateBikePage());
Route b3Builder(BuildContext ctx, RouteSettings settings) =>
    Routefly.defaultRouteBuilder(ctx, settings, const a3.BikeDetailPage());
Route b4Builder(BuildContext ctx, RouteSettings settings) =>
    Routefly.defaultRouteBuilder(ctx, settings, const a4.UpdateBikePage());
Route b5Builder(BuildContext ctx, RouteSettings settings) =>
    Routefly.defaultRouteBuilder(ctx, settings, const a5.ContactPage());
